...
namespace OFOS
{
    public partial class FoodItems : System.Web.UI.Page
    {
        ...
        {
              System.DateTime t1 = System.DateTime.Parse("2022/12/12 08:00:00.000");
              System.DateTime t2 = System.DateTime.Parse("2022/12/12 23:00:00.000");
        ...
        protected void Button_rice_onclick(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string selectSQL = "select Item_no,Item_name,Description,Image_url,Price from [dbo].[Item_Master] where (Type='meal')";
                SqlCommand cmd = new SqlCommand(selectSQL, con);
                griditem.DataSource = cmd.ExecuteReader();
                griditem.DataBind();
            }
        ...
        protected void Button_noodles_onclick(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string selectSQL = "select Item_no,Item_name,Description,Image_url,Price from [dbo].[Item_Master] where (Type='kebap')";
                SqlCommand cmd = new SqlCommand(selectSQL, con);
                griditem.DataSource = cmd.ExecuteReader();
                griditem.DataBind();
            }
